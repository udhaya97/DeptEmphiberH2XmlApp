package com.deptemphiberxmlh2dbapp.test;
...
public class EmpDeptTest {
	...
	Department dep = new Department(1,"training","pune");
 	...
 	Employee emp = new Employee(23,"manoj","mano@gmail.com","1993-02-26",894315697,46953.56f,"tcs",dep);
 	Employee emp1 = new Employee(25,"rakesh","rake@gmail.com","1991-03-26",894315697,32953.56f,"cts",dep2);
 	Employee emp2 = new Employee(26,"kiraan","ksh@gmail.com","1996-02-26",894315697,26953.56f,"ibm",dep1);
     Employee emp4 = new Employee (29,"Kumar","kum@gmail.com","1990-08-26",894315697,36953.56f,"infomatica",dep);
